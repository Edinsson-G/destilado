...
def get_model(name,dispositivo, **kwargs):
    """
    ...
    if name == "nn":
        ...
        center_pixel = True
        model = HamidaEtAl(n_bands, n_classes,dispositivo, patch_size=patch_size)
        ...
        patch_size = kwargs.setdefault("patch_size", 5)
        center_pixel = False
        model = LeeEtAl(n_bands, n_classes,dispositivo)
        ...
        center_pixel = True
        model = ChenEtAl(n_bands, n_classes,dispositivo, patch_size=patch_size)
        ...
        patch_size = kwargs.setdefault("patch_size", 5)
        center_pixel = True
        model = LiEtAl(n_bands, n_classes, dispositivo,n_planes=16, patch_size=patch_size)
        lr = kwargs.setdefault("learning_rate", 0.01)
        optimizer = optim.SGD(
        ...
        kwargs.setdefault("patch_size", 1)
        center_pixel = True
        model = HuEtAl(n_bands, n_classes,dispositivo)
        ...
        lr = kwargs.setdefault("learning_rate", 0.01)
        center_pixel = True
        model = HeEtAl(n_bands, n_classes, dispositivo,patch_size=kwargs["patch_size"])
        ...
        center_pixel = True
        model = LuoEtAl(n_bands, n_classes, dispositivo,patch_size=kwargs["patch_size"])
        ...
        model = SharmaEtAl(n_bands, n_classes,dispositivo, patch_size=kwargs["patch_size"])
        optimizer = optim.SGD(model.parameters(), lr=lr, weight_decay=0.0005)
        criterion = nn.CrossEntropyLoss(weight=kwargs["weights"])
        kwargs.setdefault(
            "scheduler",
        ...
        model = LiuEtAl(n_bands, n_classes,dispositivo, patch_size)
        optimizer = optim.SGD(model.parameters(), lr=lr)
        ...
        lr = kwargs.setdefault("lr", 0.001)
        center_pixel = True
        model = BoulchEtAl(n_bands, n_classes,dispositivo)
        optimizer = optim.SGD(model.parameters(), lr=lr)
        criterion = (
            nn.CrossEntropyLoss(weight=kwargs["weights"]),
        ...
        model = MouEtAl(n_bands, n_classes,dispositivo)
...
class HuEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes, dispositivo,kernel_size=None, pool_size=None):
    ...
    def forward(self, x):
        ...
        x = x.unsqueeze(1)
        x = self.conv(x.to(self.dispositivo))
...
class HamidaEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes, dispositivo,patch_size=5, dilation=1):
...
class LeeEtAl(nn.Module):
    ...
    def __init__(self, in_channels, n_classes,dispositivo):
...
class ChenEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes, dispositivo,patch_size=27, n_planes=32):
...
class LiEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes,dispositivo, n_planes=2, patch_size=5):
...
class HeEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes,dispositivo, patch_size=7):
    ...
    def forward(self, x):
        x = F.relu(self.conv1(x.to(self.dispositivo)))
        x2_1 = self.conv2_1(x)
        x2_2 = self.conv2_2(x)
        x2_3 = self.conv2_3(x)
        x2_4 = self.conv2_4(x)
...
class LuoEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes, dispositivo,patch_size=3, n_planes=90):
...
class SharmaEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes,dispositivo, patch_size=64):
    ...
    def forward(self, x):
        x = F.relu(self.conv1_bn(self.conv1(x.to(self.dispositivo))))
        x = self.pool1(x)
        b, t, c, w, h = x.size()
        x = x.view(b, 1, t * c, w, h)
        x = F.relu(self.conv2_bn(self.conv2(x)))
...
class LiuEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes,dispositivo, patch_size=9):
    ...
    def forward(self, x):
        x = x.squeeze()
        x_conv1 = self.conv1_bn(self.conv1(x.to(self.dispositivo)))
        x = x_conv1
...
class BoulchEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes,dispositivo, planes=16):
    ...
    def forward(self, x):
        x = x.unsqueeze(1)
        x = self.encoder(x.to(self.dispositivo))
...
class MouEtAl(nn.Module):
    ...
    def __init__(self, input_channels, n_classes,dispositivo):
    ...
    def forward(self, x):
        ...
        x = x.permute(2, 1, 0)
        x = self.gru(x.to(self.dispositivo))[0]
